    ...
    <% 
        ...
        if (request.getParameter("username") != "" && request.getParameter("password") != "") {
               ...
               l.run();
                ...
                session.setAttribute("teknisi", l.getNamaTeknisi());
                session.setAttribute("idteknisi", l.getIdTeknisi());
                
                if (l.getValidUser() != null && l.getValidPass() != null) {
                    response.sendRedirect("home.jsp");
                    session.setAttribute("valid", valid ="1");
                } else {
                response.sendRedirect("../index.jsp");
                session.setAttribute("valid", valid ="0");
                }
            }
    %>
